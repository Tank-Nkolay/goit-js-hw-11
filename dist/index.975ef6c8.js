...
var _renderImg = require("./js/render-img");
var _pixabayApiService = require("./js/pixabay-api-service");
var _pixabayApiServiceDefault = parcelHelpers.interopDefault(_pixabayApiService);
// слушаем ===
const refs = {
...
let formSubm = false;
const imageService = new (0, _pixabayApiServiceDefault.default)();
const simpeLightBoxGallery = new (0, _simplelightboxDefault.default)(".gallery a", {
    captionsData: "alt",
    captionDelay: 300
});
// обработка запроса
...
async function onSearch(e) {
    ...
    if (!query) {
        (0, _notiflixNotifyAio.Notify).warning("No data to search. Please enter");
        return;
    }
    ...
    try {
        ...
        const markup = (0, _renderImg.makeImgCards)(data);
        (0, _renderImg.renderImg)(markup, refs.imgGallery);
        formSubm = false;
        addGalleryScroll();
...
async function onLoadMore() {
    try {
        ...
        if (imageService.page - 1 === totalPages + 1) {
            (0, _notiflixNotifyAio.Notify).failure(`We're sorry, but you've reached the end of search results.`);
            return;
        }
        const markup = (0, _renderImg.makeImgCards)(data);
        (0, _renderImg.renderMoreImg)(markup, refs.imgGallery);
        simpeLightBoxGallery.refresh();
        scrollLoad();
        addGalleryScroll();
    } catch (error) {
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./js/render-img":"8SHZC","./js/pixabay-api-service":"a0sXv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"kaxSc":[function() {},{}],"8SHZC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeImgCards", ()=>makeImgCards);
parcelHelpers.export(exports, "renderMoreImg", ()=>renderMoreImg);
parcelHelpers.export(exports, "renderImg", ()=>renderImg);
function makeImgCards(result) {
    const imagesArr = result.hits;
    return imagesArr.map((image)=>`<div class="box-img">
...
},{}],"a0sXv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./../utils":"5By4s"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
